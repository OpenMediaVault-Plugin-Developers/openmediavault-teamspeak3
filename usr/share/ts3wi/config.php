...
//Language German = de, English = en, Netherlandish=nl (by pd1evl), French = fr (by supra63200)
$cfglang = "en";
...
//Define the position where the icons on the Viewer will show left or right
$showicons = "left";

//Chose your design  set 'new' for the default design or the name of your own create design
$style = "new";

//This Name will be show if you send a message to a Server
$msgsend_name = "Webinterface";

// Set it to false to not show the message of the day window
$show_motd = true;

// Set it to false to not show the Webinterface Version on the footer
$show_version = true;
?>